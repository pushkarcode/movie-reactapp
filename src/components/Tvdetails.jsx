...
const Tvdetails = () => {
  ...
  return info ? (
    <div
      ...
      className="w-screen h-[210vh] px-[10%] relative"
    >
      {/* part 1 navigation */}
      ...
      <div className="w-full flex mt-6 gap-x-32 relative ">
        ...
        <div className="content flex   flex-col gap-3">
          ...
          <div className="flex  w-[90%]  leading-none gap-x-5 border-b-[1px] border-zinc-500">
            <h1 className="text-zinc-100 text-[1.2vw] mb-4">
      ...
      <h1 className="font-[gilroy] text-3xl font-bold uppercase text-zinc-200">
        Seasons 🗿
      </h1>
      ...
      {info.detail.seasons.length > 0 ? info.detail.seasons.map((s,i) => (
        ...
        {s.poster_path ? (
          <img 
            className="h-[39vh] min-w-[13vw] object-cover rounded-md shadow-[0_3px_10px_rgb(0,0,0,0.2)]"
            src={`https://image.tmdb.org/t/p/original/${
              s.poster_path }`}
          />
        ) : (
          <img className="h-[38vh] min-w-[13vw] object-cover rounded-md" src={noimage} />
        )}
        <h1 className="text-zinc-300 text-[1.4vw] leading-[1.5vw] tracking-wider font-thin m-3 flex items-center gap-10 w-[10vw]">
            {s.name}
        ...
        <h1 className="text-[3vw] text-zinc-700 font-bold tracking-wider">Nothing to show</h1>
      )}
