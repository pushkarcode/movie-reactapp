...
const Moviedetails = () => {
  ...
  return info ? (
    <div
      ...
      className="lg:w-screen lg:w-200vh lg:h-[170vh] lg:px-[10%] px-[7%] relative overflow-x-hidden overflow-y-hidden"
    >
      {/* part 1 navigation */}
      ...
      <div className="w-full lg:flex mt-6 lg:gap-x-32 relative ">
        ...
        <div className="content flex  flex-col gap-3">
          ...
          <div className="lg:flex lg:gap-0 gap-10">
            <span className=" absolute lg:top-[80%] top-[35%] left-[88%] lg:left-[17%] rounded-full text-xl  font-semibold bg-[#6556CD] text-white w-[6vh] h-[6vh] flex justify-center items-center ">
              {(info.detail.vote_average * 10).toFixed()} <sup>%</sup>
            </span>

            <p className="text-white lg:text-[1.3vw]  border-[2px] lg:px-1 px-3 py-1 rounded-sm mr-2">
          ...
          <div className="flex w-[90%]  leading-none gap-x-5 border-b-[1px] border-zinc-500">
            <h1 className="text-zinc-100 lg:text-[1.2vw]">
            ...
            <div className="flex items-center">
              <p className="lg:text-[1.6vw] font-semibold text-zinc-100">
                Duration:
              </p>
              <button className="lg:px-3 px-2 lf:py-1 py-2 lg:mb-2 mb-3 bg-yellow-300 text-white rounded-md lg:text-xl text-sm leading-3 ml-3 font-extrabold">
          ...
          <div className="mt-5 flex items-center lg:gap-x-10 gap-x-6">
            ...
            >
              <i className=" lg:text-xl text-xl mr-1 ri-play-fill"></i>PlayTrailer
            </Link>
            <a
              target="_blank"
            ...
            >
              <i className="lg:text-xl text-xl mr-1 ri-information-line"></i>More_Info
            </a>
          </div>
        </div>
      </div>
      ...
      <h1 className="font-[gilroy] lg:text-3xl text-[7.4vw] leading-[7vw]  font-bold uppercase text-zinc-200">Recommendations and similar stuff 🔥</h1>
      <Horizontalcards
